  ...
  return (
    <header className={`${showMobileNav && "mobile-menu-visible"}`}>
      <div
        ...
        style={{ backgroundColor: "#182029", zIndex: "12", justifyContent: "center", alignSelf: "center" }}
      >
        <div className="flex justify-center align-middle">
          <div className="row">
            <div className="col-12">
              <div className="faviconCustom mobile-nav-toggler" onClick={() => setShowMobileNav(true)}>
                    ...
                    <ul className="navigation">
                      ...
                      <li className="menu-item-has-children">
                        ...
                        <ul className="sub-menu">
                          <li>
                            <Link href="/nfts/exploreNFTs" style={{ textDecoration: "none" }}><svg className="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            </svg> Explore NFTs</Link>
                          </li>
                          <li>
                            <Link href="/collection/exploreCollections" style={{ textDecoration: "none" }}> <i className="flaticon-ethereum" style={{ marginRight: "5px", fontSize: "17px" }}></i> NFT Collections</Link>
                          </li>
                          <li>
                            <Link href="/content/live/exploreLiveContent" style={{ textDecoration: "none" }}><svg className="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <li className="menu-item-has-children">
                            ...
                            {showProfileDrop &&
                              <ul className="sub-menu" style={{ overflow: "hidden", marginTop: "22px" }}>
                                ...
                                <li>
                                  <Link href={`/profile/${signerAddress}`} style={{ textDecoration: "none" }}>
              ...
              <div className="tgmobile__menu">
                <nav className="tgmobile__menu-box">
                  ...
                  {/* close btn  */}
                  <div className="close-btn" onClick={() => setShowMobileNav(false)}>
                  ...
                  <div className="tgmobile__menu-outer">
                    <ul className="navigation">
                      ...
                      <li className="menu-item-has-children">
                        <Link href="/nfts/exploreNFTs" style={{ textDecoration: "none", display: "flex" }}>
                          Explore
                        </Link>
                        <div className="dropdown-btn">
                          <span className="plus-line"></span>
                  ...
                  <div className="social-links">
                    <ul className="list-wrap">
                      <li>
                        <Link href="https://twitter.com/platform28465" target="_blank" style={{ textDecoration: "none" }}>
                          <i className="fab fa-twitter"></i>
                        </Link>
                      </li>
                      <li>
                        <Link href="https://github.com/aniruddhafb/GamerX_ThetaHack" target="_blank" style={{ textDecoration: "none" }}>
