        ...
        <div className="container">
          <div className="flex flex-wrap pt-30">
            ...
            <div className="shop__details-content">
              ...
              <div className="shop__details-qty">
                ...
                {nft_data?.isListed && (
                  <div className="shop__details-price">
                    <span className="amount">
                      {nft_data?.listingPrice} <span className="stock-status">TFUEL</span>
                    </span>
                  </div>
                )}
                ...
                {nft_data?.isListed == false && nft_data?.user_id != signerAddress &&
                  <div className="cart-plus-minus d-flex flex-wrap align-items-center">
                      ...
                      <div className=" w-[250px] relative mt-2 rounded-md shadow-sm">
                        ...
                        <div className="absolute inset-y-0 right-0 flex items-center">
                          {compLoading ?
                            ...
                            :
                            <button onClick={() => sell_nft(tokenid, listing_price, slug)} class="bg-[#68fb9a] text-[black] font-semibold hover:text-black py-[5px] px-4 border border-blue-500 hover:border-transparent rounded mt-2 mb-2">
                              List NFT
                            </button>
                          }
                        </div>
          ...
          <div className="row">
            <div className="col-12">
              <div className="product__desc-wrap" style={{ overflow: "hidden" }}>
