                ...
                <div className="flex flex-wrap pt-30">
                    <div className="shop__details-images-wrap">
                        <div className="tab-content" id="imageTabContent">
                            <div className="tab-pane show active" id="one" role="tabpanel" aria-labelledby="one-tab">
                                <a href="./nftpage_files/shop_details01.jpg" className="popup-image"><img src="./nftpage_files/shop_details01.jpg" alt="img" /></a>
                            </div>
                        </div>
                    </div>
                    <div className="shop__details-content">
                        ...
                        <div className="shop__details-price">
                            <span className="amount">106 <span className="stock-status">TFUEL</span></span>
                        </div>
                        ...
                        <div className="shop__details-qty">
                            <div className="cart-plus-minus d-flex flex-wrap align-items-center">
                                <button className="shop__details-cart-btn" fdprocessedid="6l3zsn">Buy</button>
                            </div>
                        </div>
                        ...
                        <div className="product__desc-wrap">
                            <ul className="nav nav-tabs" id="descriptionTab" role="tablist">
                                <li className="nav-item" role="presentation">
                                    <button className="nav-link active" id="description-tab" data-bs-toggle="tab" data-bs-target="#description" type="button" role="tab" aria-controls="description" aria-selected="true" fdprocessedid="tke65y">Description</button>
                                </li>
                                <li className="nav-item" role="presentation">
                                    <button className="nav-link" id="info-tab" data-bs-toggle="tab" data-bs-target="#info" type="button" role="tab" aria-controls="info" aria-selected="false" fdprocessedid="lkxd8">Other Information</button>
                                </li>
                            </ul>
                            <div className="tab-content" id="descriptionTabContent">
                                <div className="tab-pane animation-none fade active show" id="description" role="tabpanel" aria-labelledby="description-tab">
