                ...
                <div className="container">
                    <div className="mx-auto max-w-[48.125rem] md:flex">
                        <div className="mb-12 md:w-1/2 md:pr-8">
                            <div className="mb-6">
                                <label for="profile-username" style={{ fontFamily: "berlin_sans_fb_demibold", textTransform: "uppercase" }} className="mb-1 block font-display text-sm text-jacarta-700 dark:text-white"
                            ...
                            <div className="mb-6">
                                <label for="profile-bio" style={{ fontFamily: "berlin_sans_fb_demibold", textTransform: "uppercase" }} className="mb-1 block font-display text-sm text-jacarta-700 dark:text-white"
                            ...
                            <div className="mb-6">
                                <label for="profile-email" style={{ fontFamily: "berlin_sans_fb_demibold", textTransform: "uppercase" }} className="mb-1 block font-display text-sm text-jacarta-700 dark:text-white"
                            ...
                            <div className="mb-6">
                                ...
                                <button
                                    className="js-copy-clipboard flex w-full select-none items-center rounded-lg border border-jacarta-100 bg-white py-3 px-4 hover:bg-jacarta-50 dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-jacarta-300 bg-transparent"
                            ...
                            <form className="shrink-0">
                                <figure className="relative inline-block">
                                    <img
                                        ...
                                        className="rounded-xl border-[3px] border-white dark:border-jacarta-600"
                                    />
                                    <div
