              ...
              >
                      ...
                      <div className="mt-8 mb-16">
                        ...
                        <div className=" w-[250px] relative mt-2 rounded-md shadow-sm">
                          ...
                          <div className="absolute inset-y-0 right-0 flex items-center">
                            {compLoad ?
                              <button onClick={make_tip} class="flex bg-[#198754] text-[white] font-semibold hover:text-white py-[5px] px-4 border border-blue-500 hover:border-transparent rounded mt-2 mb-2">
                                Sending
                ...
                < div className="comment-respond" >
                  ...
                  <div className="comment-form" action="#">
                    ...
                    {compLoad ?
                      <button type="submit" className="flex">Posting
